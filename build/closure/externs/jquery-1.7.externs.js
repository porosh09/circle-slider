...
/**
 * @param {string} name
 * @param {Object|null|string|boolean=} opt_value
 * @return {*}
 */
...
* @param {*|Function=} func
*/
jQueryObject.prototype.on = function(arg, func) {};
...
$.fn = function() {};
$.event = function() {};
$.event.fix = function(obj) {};
$.event.handle = function(obj) {};
$.event.handle.apply = function(obj, args) {};
$.isFunction = function(callback_func) {};
$.trim = function(txt) {};
$.inArray = function(val, arr) {};
$.render;
$.templates;
$.views;
$.views.prototype.helpers;

$.fn.getScript = function(obj) {};
$.fn.done = function(obj) {};
$.fn.fail = function(obj) {};
$.fn.always = function(obj) {};
...
$.validator;
$.validator.addMethod = function(rulename, func, errormsg) {};
$.validator.optional = function(element){};
...
var lightbox;
$.LightBoxObject;
$.LightBoxObject.options.prototype.overlay;
$.LightBoxObject.options.prototype.animation;
$.LightBoxObject.options.animation.prototype.shake;
...
/* calendars */
$.calendars;
$.calendars.instance = function(){};
$.calendars.newDate = function(){};
$.calendars.daysInMonth = function(){};

/* box2d */
var b2AABB, b2World, b2Vec2, b2CircleDef, b2BodyDef, b2RevoluteJointDef;

var CodeMirror, unmark;